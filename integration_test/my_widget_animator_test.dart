...
import 'package:getx_skeleton/core/network/api_call_status.dart';
import 'package:getx_skeleton/core/widgets/my_widgets_animator.dart';
...
main() {
  testWidgets(
      'test widget animator animating between widgets according to api call status',
      (tester) async {
